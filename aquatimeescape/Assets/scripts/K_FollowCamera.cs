...
public class K_FollowCamera : MonoBehaviour {
	...
	void Update () {
		...
		if (lookTarget != null && cameracheck == false) {
			...
			Vector3 relativePos = Quaternion.Euler (lookTarget.eulerAngles.x, lookTarget.eulerAngles.y, 0) * new Vector3 (-100, 6, -distance * 2);
